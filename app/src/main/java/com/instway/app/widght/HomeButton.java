...
public class HomeButton extends FrameLayout {
    ...
    public interface HomeBtnOnClickListener {
        void onClickDown(HomeButton homebtn);

        void onClickUp(HomeButton homebtn);
    }

    public void setHomeBtbOnClickListener(HomeBtnOnClickListener homeBtnOnClickListener) {
        this.homeBtnOnClickListener = homeBtnOnClickListener;
    }

    public HomeButton(Context paramContext) {
        this(paramContext, null);
    }

    public HomeButton(Context paramContext, AttributeSet paramAttributeSet) {
        this(paramContext, paramAttributeSet, 0);
    }

    public HomeButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    class AnimaListen implements Animation.AnimationListener {
        ...
        AnimaListen(HomeButton paramHomeButtonView) {
