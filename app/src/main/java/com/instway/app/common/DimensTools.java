...
public class DimensTools {
    ...
    static String oldFilePath = "/Volumes/MacBackup/Development/github/hckpApp/app/src/main/res/values-nodpi/dimens.xml";

    /**
     * 新生成文件路径
     */

    static String filePath720 = "/Volumes/MacBackup/Development/github/hckpApp/app/src/main/res/values-1280x720/dimens.xml";

    /**
     * 新生成文件路径
     */

    static String filePath672 = "/Volumes/MacBackup/Development/github/hckpApp/app/src/main/res/values-1280x672/dimens.xml";

    /**
     * 新生成文件路径
     */

    static String filePath1080 = "/Volumes/MacBackup/Development/github/hckpApp/app/src/main/res/values-1920x1080/dimens.xml";
